...
class RoadsideScreen extends StatelessWidget {
  ...
  Future<void> _callRoadside(BuildContext context) async {
    // <-- ĐÃ SỬA: Thêm context
    ...
    if (await canLaunchUrl(uri)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        // <-- ĐÃ THÊM: Thông báo lỗi
        const SnackBar(
            content: Text(
                "Không thể thực hiện cuộc gọi. Vui lòng kiểm tra quyền hoặc số hotline."),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () =>
                    _callRoadside(context), // <-- ĐÃ SỬA: Truyền context
                style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.green,
                    padding: const EdgeInsets.all(20)),
                child: const Text('GỌI ĐỘI XE VAN',
