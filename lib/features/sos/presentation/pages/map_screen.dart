...
import 'package:sos_battery/features/sos/presentation/pages/safety_report_screen.dart'
    show SafetyReportScreen;

void _liveLocateUser() {}
...
class _MapScreenState extends State<MapScreen> {
  ...
  late ConfettiController
      _confettiController; // <-- ĐÃ THÊM: Controller pháo hoa
  ...
  void initState() {
    ...
    _liveLocateUser();
    _confettiController =
        ConfettiController(duration: const Duration(seconds: 3)); // <-- ĐÃ THÊM
  }

  @override
  void dispose() {
    // <-- ĐÃ THÊM: Dispose controller
  ...
  void _completeJob() async {
    try {
      ...
      ScaffoldMessenger.of(newMethod).showSnackBar(
        const SnackBar(
            content: Text("Dịch vụ đã hoàn tất! Cảm ơn bạn."),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text("Lỗi: Không thể hoàn tất dịch vụ. $e"),
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => SafetyReportScreen(
                          jobId: widget.jobId, isHero: widget.isHero)));
            },
        ...
        children: [
          ...
          Align(
            ...
            child: ConfettiWidget(
              ...
              blastDirectionality:
                  BlastDirectionality.explosive, // Nổ tỏa ra xung quanh
